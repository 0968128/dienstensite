...
@section('content')
    <h3>
        Ik ben ben Lucas, 18 jaar en ik maak een website waar vraag en aanbod van diensten elkaar ontmoeten.
    </h3>
    <p>
        ...
        de mail moeten jullie het vervolgens eens worden over een tijd en een prijs.
    </p>
@endsection